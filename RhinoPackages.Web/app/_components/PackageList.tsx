...
const PackageCard = memo(function PackageCard({
  ...
  return (
    ...
    >
      <div
        className="group/header mb-2 flex cursor-pointer flex-col gap-2 rounded-lg transition-shadow md:flex-row md:gap-0"
        onClick={onToggle}
      >
          ...
          <div className="flex min-w-0 flex-col">
            <div className="flex min-w-0 flex-wrap items-center gap-2">
              <button
                ...
                className="break-long-words text-left text-lg font-bold text-gray-900 transition-colors hover:text-brand-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-500 dark:text-zinc-100 dark:hover:text-brand-400 dark:focus-visible:ring-brand-400 rounded-sm"
              >
                {pkg.id}
              </button>
              {pkg.prerelease && (
